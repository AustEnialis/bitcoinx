...
Below are some notes on how to build BitcoinX Core for Windows.
...
way. This will install to `c:\workspace\bitcoinx`, for example:

    make install DESTDIR=/mnt/c/workspace/bitcoinx
