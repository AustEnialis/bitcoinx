...
const char* BIP71_MIMETYPE_PAYMENT = "application/bitcoinx-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/bitcoinx-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/bitcoinx-paymentrequest";
    ...
    if (startLocalServer)
    {
        ...
        if (!uriServer->listen(name)) {
            ...
            QMessageBox::critical(0, tr("Payment request error"),
                tr("Cannot start bitcoinx: click-to-pay handler"));
        }
        else {
    ...
    if (s.startsWith(BITCOIN_IPC_PREFIX, Qt::CaseInsensitive)) // bitcoin: URI
    {
        ...
        else // normal URI
        {
            ...
            if (GUIUtil::parseBitcoinURI(s, &recipient))
            {
                ...
                Q_EMIT message(tr("URI handling"),
                    tr("URI cannot be parsed! This can be caused by an invalid BitcoinX address or malformed URI parameters."),
                    CClientUIInterface::ICON_WARNING);
