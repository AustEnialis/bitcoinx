...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s bitcoinx-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  bitcoinx-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bitcoinx transaction") + "\n" +
              "  bitcoinx-tx [options] -create [commands]   " + _("Create hex-encoded bitcoinx transaction") + "\n" +
              "\n";
...
static const struct {
    ...
    {"ALL|ANYONECANPAY|FORKID", SIGHASH_ALL|SIGHASH_ANYONECANPAY|SIGHASH_FORKID},
    {"NONE|ANYONECANPAY|FORKID", SIGHASH_NONE|SIGHASH_ANYONECANPAY|SIGHASH_FORKID},
    {"SINGLE|ANYONECANPAY|FORKID", SIGHASH_SINGLE|SIGHASH_ANYONECANPAY|SIGHASH_FORKID},
};
