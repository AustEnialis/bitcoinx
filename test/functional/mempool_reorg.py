...
class MempoolCoinbaseTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        spend_101_raw = create_tx(self.nodes[0], coinbase_txids[1], node1_address, 499999)
        spend_102_raw = create_tx(self.nodes[0], coinbase_txids[2], node0_address, 499999)
        ...
        spend_102_1_raw = create_tx(self.nodes[0], spend_102_id, node1_address, 499998)
